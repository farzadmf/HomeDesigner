...
\hyperlink{class_wall}{Wall} renders the wall based on the distance ,location , width ,wall location and based on color or texture. 
...
{\em width} & the width \\
\hline
{\em location} & which wall \\
\hline
{\em render\+Mode} & the color of the texture \\
\hline
\end{DoxyParams}
...
Bind binds the model to the wall. 
...
Draw draws the colors textures bind the main and the other walls. 
